...
def main():
    ...
    FOLDER_PATH = '/mnt/7680BDCD80BD9459/PAR client/SOURCING _tASK_RFI0010/collated/more_collated'  #insert path to your raw images
    FILE_NAME = "RFI010_PAR-0f_Vertical 1m GSD_Wilderness Infrastructure_0"   #insert desired output format NB: avoid / because it throws a FILE-NOT-FOUND Error
